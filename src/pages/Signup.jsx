                ...
                <div className="lg:w-[600px] mx-auto bg-base-100 px-10 pt-10 pb-16">
                  ...
                  <form onSubmit={handleSignupWithEmail}>
                     <div className="flex flex-col mt-10">
                        ...
                        <input className="border bg-base-200 text-lg px-3 py-2.5 outline-none rounded font-medium" type="text" name="name" id="name" placeholder="Enter your name" required />
                     </div>
                     <div className="flex flex-col mt-6">
                        <label className="text-lg mb-2 font-medium text-gray-700" htmlFor="">Image URL</label>
                        <input className="border bg-base-200 text-lg px-3 py-2.5 outline-none rounded font-medium" type="text" name="image" id="image" placeholder="Enter your image url" required />
                     </div>
                     <div className="flex flex-col mt-6">
                     ...
                     <div className="flex flex-col mt-6">
                        ...
                        <input className="border bg-base-200 text-lg px-3 py-2.5 outline-none rounded font-medium" type="password" name="password" id="passowrd" placeholder="Enter your password" required autoComplete="" />
                     </div>
